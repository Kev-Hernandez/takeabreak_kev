...
const UsersList = () => {
  ...
  return (
    ...
    >
      {/* Navegación arriba en fila con separación */}
      ...
      {/* Botón chat general más grande y centrado con sombra y animación */}
      <Button
        variant="contained"
        startIcon={<ChatIcon />}
      ...
      {/* Lista usuarios dentro de Paper con bordes redondeados y sombra */}
      <Paper
        elevation={6}
        sx={{
          p: 3,
      ...
      >
        ...
        {loading ? (
          ...
          <Typography variant="body1" sx={{ textAlign: 'center', py: 4, color: '#555' }}>
